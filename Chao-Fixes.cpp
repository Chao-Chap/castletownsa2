...
#define COLLISION_COUNT 514
bool isInSolGarden()
{
	return CurrentLevel == LevelIDs_ChaoWorld && CurrentChaoArea == 2;
}
...
void InitLandColMemory_r()
{
	...
	
	{
		...
		WriteData((int*)0x47D67B, COLLISION_COUNT);
		WriteData((int*)0x47D484, COLLISION_COUNT);
